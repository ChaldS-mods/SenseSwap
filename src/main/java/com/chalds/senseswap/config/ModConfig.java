...
public class ModConfig {
    ...
    public int blindEffectStrength = 5; // 1-10
    public float fogIntensity = 0.95f;  // 0.0 - 1.0

    // === Audio settings ===
    // (voicechat handled at plugin level, no extra config needed)

    // === Game settings ===
    public boolean autoAssignRoles = true;
    public boolean showRolePopup = true;
    public int rolePopupDuration = 5; // seconds
