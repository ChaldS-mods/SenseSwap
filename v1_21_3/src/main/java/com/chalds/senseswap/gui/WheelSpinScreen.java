...
public class WheelSpinScreen extends Screen {
    ...
    public void render(DrawContext ctx, int mx, int my, float delta) {
        ...
        ctx.drawTexture(net.minecraft.client.render.RenderLayer::getGuiTextured, WHEEL_TEX, -size/2, -size/2, 0f, 0f, size, size, size, size);
        ctx.getMatrices().pop();

        int pW = 36, pH = 48;
        ctx.drawTexture(net.minecraft.client.render.RenderLayer::getGuiTextured, POINTER_TEX, cx - pW/2, cy - size/2 - pH + 6, 0f, 0f, pW, pH, pW, pH);
